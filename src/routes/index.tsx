...
import { Search, ArrowLeft, Rocket, LayoutList, Users, TrendingUp, Zap, Code2 } from "lucide-react";
...
function CardIcon({ name }: { name: string }) {
  ...
  switch (name) {
    ...
    case "pipeline": return <LayoutList className={cls} />;
    case "contacts": return <Users className={cls} />;
    case "deals": return <TrendingUp className={cls} />;
