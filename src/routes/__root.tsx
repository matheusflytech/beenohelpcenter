    ...
    <header className="sticky top-0 z-40 border-b border-border bg-background/90 backdrop-blur-md">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 h-16 flex items-center justify-between gap-4">
        ...
        <nav className="hidden md:flex items-center gap-6">
          <Link to="/" className={linkCls} activeProps={{ className: activeCls }} activeOptions={{ exact: true }}>Início</Link>
          <Link to="/api-docs" className={linkCls} activeProps={{ className: activeCls }}>API Docs</Link>
          <button onClick={onOpenChat} className={linkCls + " cursor-pointer bg-transparent border-none p-0"}>
            Assistente IA
          </button>
        </nav>
      ...
      {mobileOpen && (
        <div className="md:hidden border-t border-border bg-background px-4 py-3 flex flex-col gap-1">
          <Link to="/" className="py-2 text-sm font-medium text-foreground/70 hover:text-foreground" onClick={() => setMobileOpen(false)}>Início</Link>
          <Link to="/api-docs" className="py-2 text-sm font-medium text-foreground/70 hover:text-foreground" onClick={() => setMobileOpen(false)}>API Docs</Link>
          <button
          ...
          <div className="border-t border-border mt-1 pt-2 flex flex-col gap-2">
            <a href="https://app.beeno.ai/" target="_blank" rel="noopener noreferrer" className="py-2 text-sm font-medium text-foreground/70 hover:text-foreground">
              Acessar plataforma
            </a>
            <a href={WA_LINK} target="_blank" rel="noopener noreferrer" className="py-2 text-sm font-semibold text-primary">
              Falar com suporte
            </a>
          </div>
        </div>
